# HF-290: SCI Bulk Import Write-Phase Silent Failure — Diagnostic-Gated Fix
...
- The ground-truth file (`MIR_Resultados_Esperados.xlsx`) should not be in the import batch at all — it is reconciliation data. Whether HF-290 EXCLUDES it or merely handles its failure gracefully is an architect decision after Part 1. Excluding GT files by convention is a separate concern (naming heuristic) and likely out of scope for this HF.
...
```
HF-290 — SCI Bulk Import Write-Phase Silent Failure — DIAGNOSTIC-GATED.
...
*HF-290 · SCI Bulk Import Write-Phase Silent Failure · Diagnostic-Gated · 2026-06-16*
