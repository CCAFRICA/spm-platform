...
| CLT102-F7 | "View Plans" → dead Customer Launch Dashboard | P0 | ❌ OPEN | HF-072 scope (running). |
...
| ID | Finding | Priority | Status | Resolution |
|----|---------|----------|--------|------------|
| CLT102-F2 | Operate landing underwhelming | P1 | ❌ OPEN | OB-108 scope. |
...
| CLT102-F8 | Customer Launch Dashboard dead | P1 | ❌ OPEN | HF-072 (running). |
