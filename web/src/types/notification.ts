...
export const NOTIFICATION_TEMPLATES: Record<NotificationType, NotificationTemplate> = {
  ...
  plan_approved: {
    ...
    message: 'The compensation plan "{planName}" has been approved.',
    messageEs: 'El plan de compensación "{planName}" ha sido aprobado.',
    priority: 'normal',
  },
  plan_rejected: {
    type: 'plan_rejected',
    ...
    message: 'The compensation plan "{planName}" has been rejected.',
    messageEs: 'El plan de compensación "{planName}" ha sido rechazado.',
    priority: 'high',
  },
  data_quality_alert: {
