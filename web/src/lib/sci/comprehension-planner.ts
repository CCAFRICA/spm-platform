...
export function planSheetComprehension(
  ...
  for (const columnName of columns) {
    ...
    if (knownSet.has(fp.hash)) {
      ...
      const expr = { identifies: k.identifies, characterization: k.characterization, relationships: k.relationships, scope_role: k.scope_role, nature_role: k.nature_role, plan_role: k.plan_role };
