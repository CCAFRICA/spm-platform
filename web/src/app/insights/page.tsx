...
export default function InsightsPage() {
        ...
        <div className="page">
          <div className="phead">
            <div>
              ...
              <div className="sub">Performance analytics</div>
            </div>
          </div>
          <div className="empty">
  ...
  // HF-313: Vialuce wraps content in the .page frame + .phead header; else (dark/bliss) byte-identical.
  if (isVialuce) {
    return (
      <div className="page">
        {/* Header */}
        <div className="phead">
          <div>
            <h1>Insights Dashboard</h1>
            <div className="sub">Performance analytics • {insights.entityCount} entities</div>
          </div>
        </div>
