...
--   Auth users:  b0000000-0000-0000-0000-00000000000[1-3]
...
VALUES
  ('b0000000-0000-0000-0000-000000000001', 'platform@vialuce.com',
   crypt('demo-password-1', gen_salt('bf')),
   now(), '{"provider":"email","providers":["email"]}', '{"name":"VL Platform Admin"}',
   now(), now(), '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated'),
  ('b0000000-0000-0000-0000-000000000002', 'sofia@retailco.mx',
   crypt('demo-password-2', gen_salt('bf')),
   now(), '{"provider":"email","providers":["email"]}', '{"name":"Sofia Chen"}',
   now(), now(), '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated'),
  ('b0000000-0000-0000-0000-000000000003', 'diego@retailco.mx',
   crypt('demo-password-3', gen_salt('bf')),
   now(), '{"provider":"email","providers":["email"]}', '{"name":"Diego Moctezuma"}',
   now(), now(), '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated');
...
VALUES
  ('b0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001',
   '{"sub":"b0000000-0000-0000-0000-000000000001","email":"platform@vialuce.com"}',
  ...
  ('b0000000-0000-0000-0000-000000000002', 'b0000000-0000-0000-0000-000000000002',
   '{"sub":"b0000000-0000-0000-0000-000000000002","email":"sofia@retailco.mx"}',
  ...
  ('b0000000-0000-0000-0000-000000000003', 'b0000000-0000-0000-0000-000000000003',
   '{"sub":"b0000000-0000-0000-0000-000000000003","email":"diego@retailco.mx"}',
...
-- ──────────────────────────────────────────────
-- 3. PROFILES (3 users with different capabilities)
-- ──────────────────────────────────────────────
...
-- ──────────────────────────────────────────────
-- 4. ENTITIES (10 individuals + 2 locations + 1 organization = 13)
-- ──────────────────────────────────────────────
...
-- ──────────────────────────────────────────────
-- 6. RULE SET (5-layer JSONB decomposition)
...
VALUES (
  ...
  '2024-01-01',
  '2024-12-31',
  -- Layer 1: population_config — who is eligible
  '{
    "entity_types": ["individual"],
    "filters": [{"field": "status", "operator": "equals", "value": "active"}],
    "scope": "tenant"
  }',
  -- Layer 2: input_bindings — metric sources
  '{
    "optical_sales": {"source": "committed_data", "data_type": "optical_sales", "aggregation": "sum"},
    "store_sales": {"source": "committed_data", "data_type": "store_sales", "aggregation": "sum"},
    "services_revenue": {"source": "committed_data", "data_type": "services", "aggregation": "sum"},
    "insurance_premium": {"source": "committed_data", "data_type": "insurance", "aggregation": "sum"},
    "collection_rate": {"source": "committed_data", "data_type": "collections", "aggregation": "ratio"}
  }',
  -- Layer 3: components — calculation rules
  '[
    {
      "id": "optical",
      "name": "Ventas Ópticas",
      "order": 1,
      "enabled": true,
      "component_type": "matrix_lookup",
      "measurement_level": "individual",
      "config": {
        "row_metric": "optical_attainment",
        "column_metric": "optical_units",
        "row_bands": [
          {"min": 0, "max": 0.7, "label": "<70%"},
          {"min": 0.7, "max": 0.9, "label": "70-90%"},
          {"min": 0.9, "max": 1.1, "label": "90-110%"},
          {"min": 1.1, "max": 999, "label": ">110%"}
        ],
        "column_bands": [
        ...
        "values": [[0, 500, 800], [800, 1200, 1800], [1500, 2200, 3000], [2500, 3500, 5000]],
        "currency": "MXN"
      }
    },
    {
      ...
      "measurement_level": "store",
      "config": {
        "metric": "store_sales_total",
        "tiers": [
          {"min": 0, "max": 500000, "label": "<500K", "value": 0},
          {"min": 500000, "max": 800000, "label": "500K-800K", "value": 1500},
          {"min": 800000, "max": 1200000, "label": "800K-1.2M", "value": 3000},
          {"min": 1200000, "max": 999999999, "label": ">1.2M", "value": 5000}
        ],
        "currency": "MXN"
      }
    },
    ...
    },
    {
      ...
      "order": 4,
      "enabled": true,
      "component_type": "conditional_percentage",
      "measurement_level": "individual",
      "config": {
        "applied_to": "insurance_premium",
        "conditions": [
          {"metric": "collection_rate", "min": 0, "max": 0.7, "rate": 0.02, "label": "<70%"},
          {"metric": "collection_rate", "min": 0.7, "max": 0.9, "rate": 0.04, "label": "70-90%"},
          {"metric": "collection_rate", "min": 0.9, "max": 1.0, "rate": 0.06, "label": ">90%"}
        ]
      }
    }
  ]',
  -- Layer 4: cadence_config — when and how often
  '{
    "period_type": "monthly",
    "payment_lag_days": 15,
    "prorate_partial_months": true,
    "retroactive_periods": 0
  }',
  -- Layer 5: outcome_config — payout constraints
  '{
    "currency": "MXN",
    "min_payout": 0,
    "max_payout": 50000,
    "rounding": "nearest_cent",
    "tax_treatment": "supplemental"
  }',
...
-- ──────────────────────────────────────────────
-- 8. PERIODS (2024-01 through 2024-03)
-- ──────────────────────────────────────────────
...
-- ──────────────────────────────────────────────
-- 10. COMMITTED DATA (sales data for Jan 2024, 10 entities)
-- ──────────────────────────────────────────────
INSERT INTO committed_data (tenant_id, import_batch_id, entity_id, period_id, data_type, row_data, metadata) VALUES
  ...
  -- Entity 8: Pedro Hernández (Santa Fe)
  ...
  -- Entity 9: Isabella Ramírez (Santa Fe)
  ...
  -- Entity 10: Javier Morales (Santa Fe)
...
-- ──────────────────────────────────────────────
-- 11. CALCULATION BATCH (Jan 2024 — APPROVED state)
-- ──────────────────────────────────────────────
...
VALUES (
  ...
  'APPROVED',
  10,
  '{"total_payout": 95800, "avg_payout": 9580, "currency": "MXN"}',
...
-- ──────────────────────────────────────────────
-- 12. CALCULATION RESULTS (10 entities for Jan 2024)
-- ──────────────────────────────────────────────
INSERT INTO calculation_results (id, tenant_id, batch_id, entity_id, rule_set_id, period_id, total_payout, components, metrics, attainment, metadata) VALUES
  -- Sofia Chen: optical(90-110%, 50-100)=2200 + store(>1.2M)=5000 + services(4%*52000)=2080 + insurance(>90%*6%*180000)=10800 = 20080
  ('30000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001',
   ...
   20080.00,
   '[{"id":"optical","name":"Ventas Ópticas","value":2200},{"id":"store_sales","name":"Ventas Sucursal","value":5000},{"id":"services","name":"Servicios","value":2080},{"id":"insurance","name":"Seguros","value":10800}]',
  ...
  -- Diego Moctezuma: optical(90-110%, 50-100)=2200 + store(>1.2M)=5000 + services(4%*38000)=1520 + insurance(70-90%*4%*150000)=6000 = 14720
  ('30000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001',
   ...
   14720.00,
   '[{"id":"optical","name":"Ventas Ópticas","value":2200},{"id":"store_sales","name":"Ventas Sucursal","value":5000},{"id":"services","name":"Servicios","value":1520},{"id":"insurance","name":"Seguros","value":6000}]',
  ...
  -- María López: optical(70-90%, 0-50)=800 + store(>1.2M)=5000 + services(4%*22000)=880 = 6680
  ('30000000-0000-0000-0000-000000000003', 'a0000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001',
   ...
   6680.00,
   '[{"id":"optical","name":"Ventas Ópticas","value":800},{"id":"store_sales","name":"Ventas Sucursal","value":5000},{"id":"services","name":"Servicios","value":880}]',
   '{"optical_units": 45, "optical_revenue": 225000, "services_revenue": 22000, "store_sales_total": 1150000}',
   '{"optical": 0.75, "overall": 0.72}',
   '{}'),

  -- Carlos García: optical(>110%, 100+)=5000 + store(>1.2M)=5000 + services(4%*65000)=2600 + insurance(>90%*6%*220000)=13200 = 25800
  ('30000000-0000-0000-0000-000000000004', 'a0000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001',
   ...
   25800.00,
   '[{"id":"optical","name":"Ventas Ópticas","value":5000},{"id":"store_sales","name":"Ventas Sucursal","value":5000},{"id":"services","name":"Servicios","value":2600},{"id":"insurance","name":"Seguros","value":13200}]',
  ...
  -- Ana Martínez: optical(90-110%, 50-100)=2200 + store(>1.2M)=5000 + services(4%*31000)=1240 = 8440
  ('30000000-0000-0000-0000-000000000005', 'a0000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001',
   ...
   8440.00,
   '[{"id":"optical","name":"Ventas Ópticas","value":2200},{"id":"store_sales","name":"Ventas Sucursal","value":5000},{"id":"services","name":"Servicios","value":1240}]',
   '{"optical_units": 58, "optical_revenue": 290000, "services_revenue": 31000, "store_sales_total": 1150000}',
   '{"optical": 0.9063, "overall": 0.88}',
   '{}'),

  -- Roberto Silva: optical(>110%, 50-100)=3500 + store(>1.2M)=5000 + services(4%*48000)=1920 + insurance(70-90%*4%*195000)=7800 = 18220
  ('30000000-0000-0000-0000-000000000006', 'a0000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001',
   ...
   18220.00,
   '[{"id":"optical","name":"Ventas Ópticas","value":3500},{"id":"store_sales","name":"Ventas Sucursal","value":5000},{"id":"services","name":"Servicios","value":1920},{"id":"insurance","name":"Seguros","value":7800}]',
  ...
  -- Laura Torres: optical(<70%, 0-50)=0 + store(>1.2M)=5000 + services(4%*15000)=600 = 5600
  ('30000000-0000-0000-0000-000000000007', 'a0000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001',
   ...
   5600.00,
   '[{"id":"optical","name":"Ventas Ópticas","value":0},{"id":"store_sales","name":"Ventas Sucursal","value":5000},{"id":"services","name":"Servicios","value":600}]',
   '{"optical_units": 35, "optical_revenue": 175000, "services_revenue": 15000, "store_sales_total": 1150000}',
   '{"optical": 0.625, "overall": 0.58}',
   '{}'),

  -- Pedro Hernández: optical(90-110%, 50-100)=2200 + store(800K-1.2M)=3000 + services(4%*42000)=1680 = 6880
  ('30000000-0000-0000-0000-000000000008', 'a0000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001',
   ...
   6880.00,
   '[{"id":"optical","name":"Ventas Ópticas","value":2200},{"id":"store_sales","name":"Ventas Sucursal","value":3000},{"id":"services","name":"Servicios","value":1680}]',
   '{"optical_units": 78, "optical_revenue": 390000, "services_revenue": 42000, "store_sales_total": 890000}',
   '{"optical": 1.0263, "overall": 0.95}',
   '{}'),

  -- Isabella Ramírez: optical(>110%, 50-100)=3500 + store(800K-1.2M)=3000 + services(4%*55000)=2200 + insurance(70-90%*4%*200000)=8000 = 16700
  ('30000000-0000-0000-0000-000000000009', 'a0000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001',
   ...
   16700.00,
   '[{"id":"optical","name":"Ventas Ópticas","value":3500},{"id":"store_sales","name":"Ventas Sucursal","value":3000},{"id":"services","name":"Servicios","value":2200},{"id":"insurance","name":"Seguros","value":8000}]',
  ...
  -- Javier Morales: optical(70-90%, 0-50)=800 + store(800K-1.2M)=3000 + services(4%*18000)=720 = 4520
  ('30000000-0000-0000-0000-000000000010', 'a0000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001',
   ...
   4520.00,
   '[{"id":"optical","name":"Ventas Ópticas","value":800},{"id":"store_sales","name":"Ventas Sucursal","value":3000},{"id":"services","name":"Servicios","value":720}]',
   '{"optical_units": 42, "optical_revenue": 210000, "services_revenue": 18000, "store_sales_total": 890000}',
   '{"optical": 0.7, "overall": 0.65}',
   '{}');

-- ──────────────────────────────────────────────
-- 13. CALCULATION TRACES (sample for first 2 entities)
-- ──────────────────────────────────────────────
INSERT INTO calculation_traces (tenant_id, result_id, component_name, formula, inputs, output, steps) VALUES
  ('a0000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000001', 'Ventas Ópticas',
  ...
  ('a0000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000002', 'Ventas Ópticas',
...
-- ──────────────────────────────────────────────
-- 15. RECONCILIATION SESSION (completed for Jan 2024)
-- ──────────────────────────────────────────────
...
-- ──────────────────────────────────────────────
-- 16. CLASSIFICATION SIGNALS (AI-inferred relationship)
-- ──────────────────────────────────────────────
INSERT INTO classification_signals (tenant_id, entity_id, signal_type, signal_value, confidence, source, context) VALUES
  ('a0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000003', 'role_inference',
   ...
   0.8500, 'ai_classifier',
   '{"model_version": "v2", "training_data_period": "2023-Q4"}'),
...
-- ══════════════════════════════════════════════
-- MATERIALIZATION TABLES (21-23)
-- ══════════════════════════════════════════════

-- ──────────────────────────────────────────────
-- 22. PERIOD ENTITY STATE (Jan 2024 snapshot for all 13 entities)
-- ──────────────────────────────────────────────
INSERT INTO period_entity_state (tenant_id, entity_id, period_id, resolved_attributes, resolved_relationships, entity_type, status) VALUES
  ...
  ('a0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000003', 'f0000000-0000-0000-0000-000000000001',
   '{"base_salary": 28000, "hire_date": "2023-01-10", "display_name": "María López"}',
   '[{"type": "works_at", "target": "d0000000-0000-0000-0000-000000000011"}]',
   'individual', 'active'),
  ('a0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000004', 'f0000000-0000-0000-0000-000000000001',
   '{"base_salary": 30000, "hire_date": "2022-09-15", "display_name": "Carlos García"}',
   '[{"type": "works_at", "target": "d0000000-0000-0000-0000-000000000011"}]',
   'individual', 'active'),
  ('a0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000005', 'f0000000-0000-0000-0000-000000000001',
   '{"base_salary": 27000, "hire_date": "2023-04-01", "display_name": "Ana Martínez"}',
   '[{"type": "works_at", "target": "d0000000-0000-0000-0000-000000000011"}]',
   'individual', 'active'),
  ...
  ('a0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000008', 'f0000000-0000-0000-0000-000000000001',
   '{"base_salary": 29000, "hire_date": "2022-02-28", "display_name": "Pedro Hernández"}',
   '[{"type": "works_at", "target": "d0000000-0000-0000-0000-000000000012"}]',
   'individual', 'active'),
  ('a0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000009', 'f0000000-0000-0000-0000-000000000001',
   '{"base_salary": 31000, "hire_date": "2022-05-10", "display_name": "Isabella Ramírez"}',
   '[{"type": "works_at", "target": "d0000000-0000-0000-0000-000000000012"}]',
   'individual', 'active'),
  ...
  ('a0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000011', 'f0000000-0000-0000-0000-000000000001',
   ...
   '[{"type": "contains", "source": "d0000000-0000-0000-0000-000000000013"}]',
   'location', 'active'),
  ...
  ('a0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000013', 'f0000000-0000-0000-0000-000000000001',
   '{"head_count": 10, "region_code": "CDMX", "display_name": "Región Central"}',
   '[]',
   'organization', 'active');

-- ──────────────────────────────────────────────
-- 23. PROFILE SCOPE (graph-derived visibility)
-- ──────────────────────────────────────────────

-- VL Admin: sees everything (admin_override)
...
VALUES (
  ...
  ARRAY[
    ...
    'd0000000-0000-0000-0000-000000000011'::UUID, 'd0000000-0000-0000-0000-000000000012'::UUID,
...
-- Sofia Chen (tenant admin): sees all entities in tenant
INSERT INTO profile_scope (tenant_id, profile_id, scope_type, visible_entity_ids, visible_rule_set_ids, visible_period_ids, metadata)
VALUES (
  'a0000000-0000-0000-0000-000000000001',
  'c0000000-0000-0000-0000-000000000002',
...
-- Diego Moctezuma: sees only his team (graph-derived from manages relationships)
INSERT INTO profile_scope (tenant_id, profile_id, scope_type, visible_entity_ids, visible_rule_set_ids, visible_period_ids, metadata)
VALUES (
  'a0000000-0000-0000-0000-000000000001',
  'c0000000-0000-0000-0000-000000000003',
...
-- ──────────────────────────────────────────────
-- 24. ENTITY PERIOD OUTCOMES (aggregated Jan 2024)
-- ──────────────────────────────────────────────
